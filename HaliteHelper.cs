...
public class Map
{
    ...
    /// </summary>
    public Site this[Location location]
    {
    ...
    public ushort Width
    {
        get { return (ushort) _sites.GetLength(0); }
    }
    ...
    {
        get { return (ushort) _sites.GetLength(1); }
    }
...
{
    static string _LogFileName = string.Format("halitelog.txt");
